...
const postNewPassword = async (req, res, next) => {
    try {
      ...
      if (!req.session.userData || !req.session.userData.email) {
        console.log("Session expired or invalid"); // Debugging line
        return res.status(400).json({
          success: false,
      ...
      if (newPass1 === newPass2) {
        ...
        if (result.modifiedCount === 1) {
          ...
          console.log("Password update failed"); // Debugging line
      ...
      console.error("Error in postNewPassword:", error); // Debugging line
